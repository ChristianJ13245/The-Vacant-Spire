{
  ...
  "resourceVersion": "1.0",
  "name": "HTML5",
  "option_html5_browser_title": "The Vacant Spire",
  ...
  "option_html5_jsprepend": "(function(){function tvsCanvasPolish(){var c=document.getElementsByTagName(\"canvas\");for(var i=0;i<c.length;i++){c[i].style.imageRendering=\"pixelated\";c[i].style.filter=\"saturate(1.16) contrast(1.05) brightness(1.04)\";}}window.addEventListener(\"load\",function(){tvsCanvasPolish();setTimeout(tvsCanvasPolish,250);setTimeout(tvsCanvasPolish,1000);});setInterval(tvsCanvasPolish,2000);})();",
